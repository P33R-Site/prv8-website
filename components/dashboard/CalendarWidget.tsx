            ...
            <div className="grid grid-cols-7 gap-1 flex-1 content-start">
                {days.map(day => {
                    ...
                    return (
                        ...
                        ${isSelected ? 'bg-amber-500 text-black font-bold scale-110 shadow-lg shadow-amber-500/20' : ''}
                        ${isRange ? 'bg-amber-500/20 text-amber-400' : ''}
                        ${!isSelected && !isRange ? 'text-white/60 hover:bg-white/5' : ''}
                    `}
                        >
                            {day}
                        </div>
